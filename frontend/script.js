document.addEventListener("DOMContentLoaded", () => {
 ...
 // JavaScript to toggle the conversation log
 ...
 toggleButton.addEventListener('click', () => {
     ...
     if (isLogVisible) {
         ...
         conversationLog.scrollIntoView({ behavior: 'smooth', block: 'start' });
 
         // Update button text and position
         toggleButton.textContent = 'Hide Log';
         toggleButton.style.right = `${conversationLog.offsetWidth + 20}px`;
     } else {
         // Hide the conversation log
